...
fun View.showSnackbarWithCustomColor(view: android.view.View, message: String,
                                     ...
                                     duration: Int) {
    val finalEtalase = if (TextUtils.isEmpty(message)) {
    ...
    val snackView = Snackbar.make(view, finalEtalase, finalDuration)
...
fun View.showSnackbarDefault(view: android.view.View, message: String, duration: Int = Snackbar.LENGTH_LONG) {
    ...
    Snackbar.make(view, finalEtalase, finalDuration).show()
}
...
fun View.setupSnackbar(lifecycleOwner: LifecycleOwner,
                       snackbarEtalaseLiveEvent: SingleLiveEvent<String>, timeLength: Int) {
    snackbarEtalaseLiveEvent.observe(lifecycleOwner, Observer {
